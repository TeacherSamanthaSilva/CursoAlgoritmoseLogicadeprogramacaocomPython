for numero in [326, 300, 100, 320, 310,305, 301, 101, 311, 111, 25, 20, 10, 21, 11, 1, 7 , 16]:
    ...
    # Importante observar que podemos fazer esse algoritmo facilmente em Python por ser uma
    # linguagem dinâmicamente tipada, ou seja, se eu quiser mudar o valor de uma variável que era
    # do tipo inteiro para um valor do tipo string ou qualquer outro eu posso
    # Em linguagens como C++ seria necessário declarar 2 variáveis: 1 para o número e outra para o texto
